...
tools like ``brainstate.compile.for_loop``\ and ``brainstate.random``
...
.. code:: ipython3
    ...
    # Compile step function using brainstate.compile.for_loop
    us, inps = brainstate.compile.for_loop(
        ...
        pbar=brainstate.compile.ProgressBar(10) # Update progress bar every 10 steps
    )
