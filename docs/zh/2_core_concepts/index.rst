...
本节解释 [ANONYMOUS_PROJECT] 库的设计原则、模块组织和概念基础。这些文档侧重于"为什么"和"何时"而非"如何"——帮助您理解库的架构并就使用组件做出明智决策。
...
:doc:`02_model_collections`
   探索三个模型类别：基础 CANN 模型、具有学习机制的脑启发模型，以及结合 [ANONYMOUS_PROJECT] 与 ANNs 的混合模型。理解 BrainPy 基础及如何实现自定义模型。
