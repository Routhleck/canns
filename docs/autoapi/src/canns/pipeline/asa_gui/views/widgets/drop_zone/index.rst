src.canns.pipeline.asa_gui.views.widgets.drop_zone
==================================================

.. py:module:: src.canns.pipeline.asa_gui.views.widgets.drop_zone
...
.. autoapisummary::
   ...
   src.canns.pipeline.asa_gui.views.widgets.drop_zone.DropZone
