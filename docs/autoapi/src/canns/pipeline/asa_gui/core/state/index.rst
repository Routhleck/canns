src.canns.pipeline.asa_gui.core.state
=====================================

.. py:module:: src.canns.pipeline.asa_gui.core.state
...
.. autoapisummary::
   ...
   src.canns.pipeline.asa_gui.core.state.StateManager
   src.canns.pipeline.asa_gui.core.state.WorkflowState
...
.. autoapisummary::
   ...
   src.canns.pipeline.asa_gui.core.state.relative_path
   src.canns.pipeline.asa_gui.core.state.resolve_path
   src.canns.pipeline.asa_gui.core.state.validate_files
   src.canns.pipeline.asa_gui.core.state.validate_preprocessing
