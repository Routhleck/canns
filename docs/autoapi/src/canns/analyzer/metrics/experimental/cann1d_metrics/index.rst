src.canns.analyzer.metrics.experimental.cann1d_metrics
======================================================

.. py:module:: src.canns.analyzer.metrics.experimental.cann1d_metrics
...
.. autoapisummary::
   ...
   src.canns.analyzer.metrics.experimental.cann1d_metrics.HAS_NUMBA
   src.canns.analyzer.metrics.experimental.cann1d_metrics.data
...
.. autoapisummary::
   ...
   src.canns.analyzer.metrics.experimental.cann1d_metrics.AnimationError
   src.canns.analyzer.metrics.experimental.cann1d_metrics.CANN1DError
   src.canns.analyzer.metrics.experimental.cann1d_metrics.FittingError
...
.. autoapisummary::
   ...
   src.canns.analyzer.metrics.experimental.cann1d_metrics.AnimationConfig
   src.canns.analyzer.metrics.experimental.cann1d_metrics.BumpFitsConfig
   src.canns.analyzer.metrics.experimental.cann1d_metrics.CANN1DPlotConfig
   src.canns.analyzer.metrics.experimental.cann1d_metrics.Constants
   src.canns.analyzer.metrics.experimental.cann1d_metrics.SiteBump
...
.. autoapisummary::
   ...
   src.canns.analyzer.metrics.experimental.cann1d_metrics.bump_fits
   src.canns.analyzer.metrics.experimental.cann1d_metrics.create_1d_bump_animation
