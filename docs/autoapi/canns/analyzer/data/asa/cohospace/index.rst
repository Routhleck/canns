...
.. autoapisummary::
   ...
   canns.analyzer.data.asa.cohospace.compute_cohoscore_1d
   canns.analyzer.data.asa.cohospace.compute_cohoscore_2d
   canns.analyzer.data.asa.cohospace.draw_torus_parallelogram_grid
   canns.analyzer.data.asa.cohospace.plot_cohospace_neuron_1d
   canns.analyzer.data.asa.cohospace.plot_cohospace_neuron_2d
   canns.analyzer.data.asa.cohospace.plot_cohospace_neuron_skewed
   canns.analyzer.data.asa.cohospace.plot_cohospace_population_1d
   canns.analyzer.data.asa.cohospace.plot_cohospace_population_2d
   canns.analyzer.data.asa.cohospace.plot_cohospace_population_skewed
   canns.analyzer.data.asa.cohospace.plot_cohospace_trajectory_1d
   canns.analyzer.data.asa.cohospace.plot_cohospace_trajectory_2d
   canns.analyzer.data.asa.cohospace.skew_transform_torus
   canns.analyzer.data.asa.cohospace.tile_parallelogram_points
...
.. py:function:: draw_torus_parallelogram_grid(ax, n_tiles=1, color='0.7', lw=1.0, alpha=0.8)
...
.. py:function:: skew_transform_torus(coords)
   ...
   :param coords: Angles (theta1, theta2) in radians.
   :type coords: ndarray, shape (T, 2)

   :returns: **xy** -- Skewed planar coordinates.
   :rtype: ndarray, shape (T, 2)


.. py:function:: tile_parallelogram_points(xy, n_tiles=1)
   ...
   :param points: Points in the skewed plane (same coordinates as returned by `skew_transform_torus`).
