...
class HelmholtzMachine(BrainInspiredModel):
    ...
    def init_state(self):
        ...
        self.b_rec = brainstate.ParamState(jnp.zeros(self.num_hidden, dtype=jnp.float32))
        ...
        self.b_gen = brainstate.ParamState(jnp.zeros(self.num_visible, dtype=jnp.float32))
    ...
    def resize(
        self, num_visible: int, num_hidden: int | None = None, preserve_submatrix: bool = True
    ):
        """
