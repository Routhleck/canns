...
class LIFSpikingNetwork(BrainInspiredModel):
    ...
    def init_state(self):
        ...
        # Membrane potentials
        self.V = brainstate.HiddenState(jnp.ones(self.num_neurons, dtype=jnp.float32) * self.v_rest)
        ...
        self.x_trace = brainstate.HiddenState(jnp.zeros(self.num_neurons, dtype=jnp.float32))
