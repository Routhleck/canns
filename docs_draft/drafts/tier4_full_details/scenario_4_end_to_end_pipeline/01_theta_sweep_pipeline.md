...
1. [Introduction to Pipelines](#1-introduction-to-pipelines)
2. [Quick Start: Basic Pipeline Usage](#2-quick-start-basic-pipeline-usage)
3. [Loading External Trajectory Data](#3-loading-external-trajectory-data)
4. [Advanced Customization](#4-advanced-customization)
5. [Complete Research Example](#5-complete-research-example)
...
- No need to understand CANN mathematics
- Focus on your data and questions
- Reproducible, standardized analyses
...
- Direction cell network simulation
- Grid cell network simulation
- Theta modulation computation
- Population activity analysis

**Outputs**:
- Trajectory analysis plots
- Theta sweep animations
...
**Common issues**:
- Positions not in meters? Scale appropriately
- Times not in seconds? Convert first
- Non-uniform sampling? Pipeline handles automatically
...
# Example analysis: Phase precession
...
**Perfect for**:
- Experimental neuroscientists without coding expertise
...
- Need non-standard model architectures
- Implementing new analysis methods
- Fine-grained control over every step
- Extending the pipeline functionality
...
- **Related**: [Tutorials 1-7](../scenario_1_cann_modeling/01_build_cann_model.md) - Understanding models in detail
- **Related**: [Scenario 3](../scenario_3_brain_inspired_learning/01_pattern_storage_recall.md) - Brain-inspired learning
...
2. **Inherit and customize**:
   ...
   class MyCustomPipeline(ThetaSweepPipeline):
       def custom_analysis(self):
           ...
           pass
   ```
3. **Contribute**: Submit enhancements via GitHub pull requests

### Getting Help

- **Documentation**: [https://canns.readthedocs.io](https://canns.readthedocs.io)
- **Examples**: See `examples/pipeline/` directory
- **Issues**: [GitHub Issues](https://github.com/PKU-NIP-Lab/CANNs/issues)
